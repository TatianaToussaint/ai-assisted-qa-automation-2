...
test.describe('Positive Flows', () => {
  test('TC-DS2-001: edit form opens with pre-populated fields', async ({ page }) => {
    const { name, description } = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-002: successfully rename a program', async ({ page }) => {
    const original = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-003: edit description only preserves program name', async ({ page }) => {
  ...
  test('TC-DS2-004: edit both program name and description in one save', async ({ page }) => {
    const program = await seedProgram(page, 'Data Science 2026', 'Introductory data science track');
  ...
  test('TC-DS2-005: edit program name with special characters', async ({ page }) => {
    const program = await seedProgram(page, 'Software Engineering Basics', 'Core software engineering fundamentals');
  ...
  test('TC-DS2-006: program list refreshes after successful edit', async ({ page }) => {
    const program = await seedProgram(page, 'Cloud Engineering 2026', 'AWS and Azure cloud engineering track');
  ...
  test('TC-DS2-007: save edit with no field changes', async ({ page }) => {
    const program = await seedProgram(page, 'Mobile Development 2026', 'iOS and Android development program');
...
test.describe('Negative Flows', () => {
  test('TC-DS2-008: save blocked when program name is cleared', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-011: cancel edit discards unsaved changes', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
    const updatedName = uniqueProgramName('Web Development 2026 - Updated');
...
test.describe('Edge Cases', () => {
  test('TC-DS2-013: program name at maximum allowed length on edit', async ({ page }) => {
    const program = await seedProgram(page, 'Short Name Program', 'Program for max-length edit test');
  ...
  test('TC-DS2-015: whitespace-only program name treated as empty on edit', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-017: unicode and extended special characters in edited program name', async ({ page }) => {
    const program = await seedProgram(page, 'International Program', 'Global curriculum program');
  ...
  test('TC-DS2-019: concurrent edit by two admin sessions', async ({ browser }) => {
    ...
    await createProgram(pageA, programName, description);
  ...
  test('TC-DS2-020: double-click save does not cause duplicate updates or errors', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-021: clear description only preserves program name', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
  ...
  test('TC-DS2-022: description at maximum allowed length on edit', async ({ page }) => {
    const program = await seedProgram(page, 'Long Description Edit Test', 'short');
  ...
  test('TC-DS2-023: dismiss edit form via escape key without saving', async ({ page }) => {
    const program = await seedProgram(page, 'Web Development 2026', 'Full-stack web development program');
    const updatedName = uniqueProgramName('Web Development 2026 - Updated');
